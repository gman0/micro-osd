...
# ceph auth get-or-create client.admin mds 'allow *' mgr 'allow *' mon 'allow *' osd 'allow *' -o /etc/ceph/client.admin.keyring

if [[ -f ${DIR}/keyrings/keyrings ]] && [[ -s ${DIR}/keyrings/keyrings ]]; then
    cat ${DIR}/keyrings/keyrings
    ceph auth import -i ${DIR}/keyrings/keyrings
fi
